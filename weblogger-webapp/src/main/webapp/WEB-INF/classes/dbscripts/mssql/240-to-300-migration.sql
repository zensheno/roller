...
-- add new columns which hold the multi-lang settings for a weblog
    alter table website add enablemultilang bit default 0 not null;  
    alter table website add showalllangs bit default 1 not null;  

-- add new column which holds the hidden status for a page, default is false
    alter table webpage add hidden bit default 0 not null;  

-- add new column which holds the hidden status for a page, default is false
    alter table webpage add navbar bit default 0 not null;  
